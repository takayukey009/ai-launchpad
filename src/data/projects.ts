...
export const INITIAL_PROJECTS: Project[] = [
  {
    id: 'yagate-live-showcase',
    number: 'No.001',
    title: 'YAGATE LIVE // お笑いライブ公式ショーケースLP',
    description: 'GATE所属芸人によるお笑いライブ「YAGATE」の公式LP。和モダンな3Dめくり札アニメーション、全37公演の横スクロールアーカイブを搭載。',
    category: 'lp',
    status: 'live',
    url: 'https://www.yagate.jp/',
    githubUrl: 'https://github.com/takayukey009/live-event-showcase',
    tags: ['LP', '和モダン', 'アニメーション', 'お笑いライブ', 'イベント'],
    aiTools: ['Antigravity', 'Claude 3.7 Sonnet', 'Vanilla CSS / JS'],
    createdAt: '2026-03',
    starred: true,
    features: [
      '和モダン（墨・紅・生成り・金）の洗練されたデザイントークン',
      '3Dパースペクティブのめくり札出演者ラインナップ',
      '全37公演のアーカイブ閲覧＆動画ファサード'
    ],
    promptNotes: '「GATE事務所ライブ『YAGATE』の世界観を表現する和モダンかつ動きのある公式ショーケースLP」をAIとペアプロして制作。'
  },
  {
    ...
    githubUrl: 'https://github.com/takayukey009/hina-tasks',
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/takayukey009/ai-diff-lab',
